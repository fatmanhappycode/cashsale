...
public class SocketServlet {
	...
	public void message(Session session, String json) {
		...
		try {
			toSession.getBasicRemote().sendText(JSONObject.toJSONString(msg));
    ...
    private static CopyOnWriteArraySet<SocketServlet> webSocketSet = new CopyOnWriteArraySet<SocketServlet>();
    ...
    public void onMessage(String message, Session session) {
        ...
        //群发消息
        for(SocketServlet item: webSocketSet){
            try {
